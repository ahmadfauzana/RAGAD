...
root = "/media/fauzan/7246131B4612E021/Fauzan/Study PhD/Research/DMAD/mvtec_anomaly_detection/"
...
for item in item_list:
    ...
    with torch.no_grad():
        for inputs, _ in dataloader:
            ...
            features = features.to(torch.float16) # Convert to float16 to reduce memory usage
...
np.save('db_features.npy', features_db)
print("Features saved to 'db_features.npy'")